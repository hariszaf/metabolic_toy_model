...
# Configure Cobra to use GLPK solver
...
def apply_env(env_dict, model, upper_bound=1000, make_copy=False):
...
def plot_flux_heatmap(flux_df, output_path=None, figsize=(12, 10), method='average', metric='correlation'):
